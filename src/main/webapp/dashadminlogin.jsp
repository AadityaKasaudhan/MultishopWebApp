        ...
        <main>
            ...
            <!-- End of Analyses -->
             ...
             <!--Enter Coder Here-->
           	  ...
           	  <table border="1" style="border-radius:20px; margin-top:20px;">
                <tr style="background-color:#fff;  font-weight:bold;">
                	<td style="width:350px; color:black;"> <center>Name</center></td>
                	<td style="width:200px; color:black;"><center> Password</center></td>
                </tr>
				...
				<% 
					...
					ResultSet rs=null;
						try {
							...
							conn=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/MULTISHOP2","root","Aaditya@#987Kas");
